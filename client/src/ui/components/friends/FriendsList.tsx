...
const FriendsList: React.FC<FriendsListProps> = ({
  ...
  return (
    <div
      className={`flex flex-col items-center bg-gray-200 w-1/3 min-w-[150px] h-full ${
        isMobile
          ? "border-r-4 border-purple-100"
          : "rounded-2xl mr-10 border-l-4 border-b-4 border-purple-100"
      }`}
    >
      <Title title="CHATS" />
      ...
      <div className="search-bar-container p-4 w-full flex justify-center">
        <input
          ...
          placeholder="Search ..."
          className="bg-gray-100 w-4/5 min-w-[120px] rounded-xl pl-4 text-white"
        ></input>
      </div>
      ...
      <div className="add-friend-container p-4 text-white flex items-center">
        <input
          ...
          className="bg-gray-100 w-full h-8 rounded-xl pl-4 text-white mr-4 text-base"
        ></input>
