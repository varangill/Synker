...
public interface ProfileDao {
    ...
    @SqlUpdate("UPDATE profiles SET description = COALESCE(:description, description), "
            + "status = COALESCE(:status, status), profile_picture_url = "
            + "COALESCE(:profilePictureUrl, profile_picture_url), personality_one = "
            + "COALESCE(:personalityOne, personality_one), personality_two = "
            + "COALESCE(:personalityTwo, personality_two), personality_three = "
            + "COALESCE(:personalityThree, personality_three), personality_four = "
            + "COALESCE(:personalityFour, personality_four) WHERE user_id = :userId")
